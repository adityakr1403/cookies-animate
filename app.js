...
tl.fromTo('.cookie-container', { scale: 0, opacity:0 }, {opacity:1, scale: 1, ease: "elastic.out(1, 0.4)", duration: 1.5 })
tl.fromTo('.cookie', { opacity: 0, x: -50, rotation: '-45deg' }, { x: 0, opacity: 1, rotation: '0deg' },'<50%')
